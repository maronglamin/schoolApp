...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2 col-sm-6 col-md-4 col-md-offset-4 well">
            <h3 class="text-center text-primary">WELCOME! PLEASE SIGN UP</h3><br>
            <?php
            if ($_POST) {
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <a href="<?= PROOT ?>index.php" class="btn btn-default btn-block">Cancel</a>
                    <br>
                    Have an account! <a href="<?= PROOT ?>index.php">Sign in</a>
                </div>
                <br>
            </form>
        </div>
